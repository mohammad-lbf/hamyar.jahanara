    ...
    return (
        <div className="container">
            ...
            <div className="row flex-lg-row justify-content-center">
                <Teacher image={"/images/components/modules/teachers/no-image.jpg"} teacher={"سرکار خانم ابراهیمی"} post={"معاونت آموزشی"} md={"6"} lg={"3"} />
                ...
                <Teacher image={"/images/components/modules/teachers/no-image.jpg"} teacher={"سرکار خانم خطیبی"} post={"معاونت اجرایی"} md={"6"} lg={"3"} />
            </div>
            <div className="row flex-lg-row justify-content-center">
            <div className="col-12 px-lg-0 py-3 d-flex justify-content-center flex-column align-items-center">
                ...
                <Teacher image={"/images/components/modules/teachers/no-image.jpg"} teacher={"سرکار خانم امراللهی"} post={"آموزگار"} md={"4"} lg={"3"} />
            ...
            <div className="col-12 px-lg-0 py-3 d-flex justify-content-center flex-column align-items-center">
                ...
                <Teacher image={"/images/components/modules/teachers/no-image.jpg"} teacher={"سرکار خانم باقریان"} post={"آموزگار"} md={"6"} lg={"3"} />
                <Teacher image={"/images/components/modules/teachers/no-image.jpg"} teacher={"سرکار خانم سلطانی"} post={"آموزگار"} md={"6"} lg={"3"} />
            </div>
            <div className="row flex-lg-row justify-content-center">
            <div className="col-12 px-lg-0 py-3 d-flex justify-content-center flex-column align-items-center">
