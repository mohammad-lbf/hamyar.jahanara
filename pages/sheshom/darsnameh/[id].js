...
import data from '@/DB/sheshom/darsnameh';
...
const Page = () => {
    ...
    return (
        <div style={{minHeight:"100vh"}} className='page-padding-tops'>
            <div style={{marginTop:"50px" , paddingTop:"20px" , paddingBottom:"20px"}} className='container bg-white rounded shadow-sm border'>
                <div className='d-flex'>
                <Link href={"/"} style={{fontFamily:"KalamehWeb-Bold"}}>
                    صفحه اصلی
                </Link>
                <i class="bi bi-chevron-left mx-2"></i>
                <Link href={"/bases"} style={{fontFamily:"KalamehWeb-Bold"}}>
                    پایه ها
                </Link>
                <i class="bi bi-chevron-left mx-2"></i>
                <Link href={"/sheshom"} style={{fontFamily:"KalamehWeb-Bold"}}>
                    ششم
                </Link>
                <i class="bi bi-chevron-left mx-2"></i>
                <Link href={"/sheshom/mohtava"} style={{fontFamily:"KalamehWeb-Bold"}}>
                    درسنامه آموزشی
                </Link>
                </div>
            </div>
                        ...
                        <div className='row justify-content-center justify-content-lg-start align-items-start'>
                                ...
                                <div className='col-12 col-lg-10 d-flex flex-column align-items-center align-items-lg-start mt-3'>
                                        ...
                                        <div className='bg-danger text-white rounded px-3 mt-2'>
                                            ...
                                            {currentFileData.fileType == "PPTX" && <i class="pb-2 bi bi-filetype-pptx text-white fs-5"></i>}
                                            </div>
                                        </div>
                                            ...
                                            <a  download className='mt-3 btn-main-2 2 text-center d-inline-block text-white w-100' style={{borderRadius:"0" , fontFamily:"KalamehWeb-Bold"}} href={`${currentFileData.src}`}>دریافت فایل</a>
                                </div>
                        </div>
                    </div>
            </div>
            ...
            <div className='container'>
                ...
                آخرین درسنامه های آموزشی پایه ششم
                </h2>
                </div>
