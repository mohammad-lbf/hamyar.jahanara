...
import darsnameh from '@/DB/sheshom/darsnameh';
import mohtava from '@/DB/sheshom/mohtava';
import soalat from '@/DB/sheshom/soalat';
import tarhedars from '@/DB/sheshom/tarhedars';
    ...
    <div className='row align-items-center'>
        ...
        <div className='row justify-content-center'>
            <div className='col-12 col-sm-6 col-xl-4 col-xxl-3 mb-4 mt-2 mb-lh-0 d-flex justify-content-center'>
                <ToolsMenuOption type={"soalat"} number={soalat.length} slug="/sheshom/soalat" />
            </div>
            <div className='col-12 col-sm-6 col-xl-4 col-xxl-3 mb-4 mt-2 mb-lh-0'>
                    <ToolsMenuOption type={"tarhedars"} number={tarhedars.length} slug={"/sheshom/tarhedars"} />
            </div>
            <div className='col-12 col-sm-6 col-xl-4 col-xxl-3 mb-4 mt-2 mb-lh-0'>
                    <ToolsMenuOption type={"mohtava"} number={mohtava.length} slug={"/sheshom/mohtava"} />
            </div>
            <div className='col-12 col-sm-6 col-xl-4 col-xxl-3 mb-4 mt-2 mb-lh-0'>
                <ToolsMenuOption type={"darsnameh"} number={darsnameh.length} slug={"/sheshom/darsnameh"}  />
            </div>
        </div>
        </div>
