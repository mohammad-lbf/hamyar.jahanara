                ...
                <div style={{marginTop:"50px" , paddingTop:"50px" , paddingBottom:"50px"}} className='container bg-white rounded shadow border'>
                    <div className='row align-items-center'>
                            <div className='col-12 col-lg-7'>
                                ...
                                style={{fontSize:"15px" , fontFamily:"KalamehWeb-Medium" , color:"#000" , lineHeight:"1.6rem"}}>برای مشاهده ابزار پایه ی تحصیلی خود، روی پایه مورد نظر کلیک کنید</p>
                            </div>
                            <div className='col-12 col-lg-5 text-center text-lg-start'>
                                    <Image style={{width:"100px" , height:"100px"}} src={"/images/components/modules/bases.png"} height={512} width={512} />
                            </div>
                    </div>
                </div>
                ...
                <div className='row align-items-center justify-content-center'>
                            <div className='col-12 col-md-6 col-xl-4 col-xxl-3 d-flex justify-content-center'>
                                <div className='bg-white rounded border shadow-sm d-flex flex-column align-items-center mb-3' style={{width:"300px" , height:"185px"}}>
                                    <Link className='py-3 text-center' style={{width:"300px" , height:"185px"}} href={"/sevom"}>
                                        <Image style={{width:"100px" , height:"100px" }} src={"/images/components/modules/number-3.png"} width={512} height={512} />
                                        <p className='mt-4' style={{fontSize:"20px" , fontFamily:"KalamehWeb-Bold" , color:"#03004e"}}>پایه سوم</p>
                                    </Link>
                                </div>
                            </div>
                            <div className='col-12 col-md-6 col-xl-4 col-xxl-3 d-flex justify-content-center'>
                                <div className='bg-white rounded border shadow-sm d-flex flex-column align-items-center mb-3' style={{width:"300px" , height:"185px"}}>
                                    <Link className='py-3 text-center' style={{width:"300px" , height:"185px"}} href={"/chaharom"}>
                                        <Image style={{width:"100px" , height:"100px" }} src={"/images/components/modules/number-4.png"} width={512} height={512} />
                                        <p className='mt-4' style={{fontSize:"20px" , fontFamily:"KalamehWeb-Bold" , color:"#03004e"}}>پایه چهارم</p>
                                    </Link>
                                </div>
                            </div>
                            <div className='col-12 col-md-6 col-xl-4 col-xxl-3 d-flex justify-content-center'>
                                <div className='bg-white rounded border shadow-sm d-flex flex-column align-items-center mb-3' style={{width:"300px" , height:"185px"}}>
                                    <Link className='py-3 text-center' style={{width:"300px" , height:"185px"}} href={"/panjom"}>
                                        <Image style={{width:"100px" , height:"100px" }} src={"/images/components/modules/number-5.png"} width={512} height={512} />
                                        <p className='mt-4' style={{fontSize:"20px" , fontFamily:"KalamehWeb-Bold" , color:"#03004e"}}>پایه پنجم</p>
                                    </Link>
                                </div>
                            </div>
                            <div className='col-12 col-md-6 col-xl-4 col-xxl-3 d-flex justify-content-center'>
                                <div className='bg-white rounded border shadow-sm d-flex flex-column align-items-center mb-3' style={{width:"300px" , height:"185px"}}>
                                    <Link className='py-3 text-center' style={{width:"300px" , height:"185px"}} href={"/sheshom"}>
                                        <Image style={{width:"100px" , height:"100px" }} src={"/images/components/modules/number-6.png"} width={512} height={512} />
                                        <p className='mt-4' style={{fontSize:"20px" , fontFamily:"KalamehWeb-Bold" , color:"#03004e"}}>پایه ششم</p>
                                    </Link>
                                </div>
                            </div>
                    </div>
