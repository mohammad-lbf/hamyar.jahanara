...
import data from '@/DB/chaharom/mohtava';
    ...
    return (
        <div style={{minHeight:"100vh"}} className='page-padding-tops'>
            <div style={{marginTop:"50px" , paddingTop:"20px" , paddingBottom:"20px"}} className='container bg-white rounded shadow-sm border'>
                ...
                <i class="bi bi-chevron-left mx-2"></i>
                <Link href={"/chaharom"} style={{fontFamily:"KalamehWeb-Bold"}}>
                    چهارم
                </Link>
                <i class="bi bi-chevron-left mx-2"></i>
                <Link href={"/chaharom/mohtava"} style={{fontFamily:"KalamehWeb-Bold"}}>
                    محتوای آموزشی
                </Link>
                </div>
            </div>
                                ...
                                <div className={`col-12 ${currentFileData.fileType == "video" ? "col-lg-6" : "col-lg-10"} d-flex flex-column align-items-center align-items-lg-start mt-3`}>
                                        ...
                                        <div className='bg-danger text-white rounded px-3 mt-2'>
                                            ...
                                            <div className="mb-1 d-flex justify-content-center mt-3">
                                                ...
                                                <p style={{fontFamily:"KalamehWeb-Medium" , color:"#000"}}>بارگذاری شده توسط: {currentFileData.creator}</p>
                                            </div>
                                            <div className="mb-1 d-flex justify-content-center mt-3">
            ...
            <div className='container'>
                ...
                آخرین محتوای آموزشی پایه چهارم
                </h2>
                </div>
