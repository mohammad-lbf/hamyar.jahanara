...
import data from '@/DB/panjom/darsnameh';
    ...
    return (
        <div style={{minHeight:"100vh"}} className='page-padding-tops'>
            <div style={{marginTop:"50px" , paddingTop:"20px" , paddingBottom:"20px"}} className='container bg-white rounded shadow-sm border'>
                ...
                <i class="bi bi-chevron-left mx-2"></i>
                <Link href={"/panjom"} style={{fontFamily:"KalamehWeb-Bold"}}>
                    پنجم
                </Link>
                <i class="bi bi-chevron-left mx-2"></i>
                <Link href={"/panjom/mohtava"} style={{fontFamily:"KalamehWeb-Bold"}}>
                    درسنامه آموزشی
                </Link>
                </div>
            </div>
            ...
            <div className='container'>
                ...
                آخرین درسنامه های آموزشی پایه پنجم
                </h2>
                </div>
